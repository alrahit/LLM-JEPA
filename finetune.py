...
def main():
    ...
    parser.add_argument("--batch_size", type=int, default=1, help="Per device batch size")  # CHANGED: 4 → 1 for RTX 4050 6GB VRAM
    parser.add_argument("--grad_accum", type=int, default=16, help="Gradient accumulation steps")  # CHANGED: 4 → 16 to keep effective batch size = 16 (1×16)
    ...
    training_args = TrainingArguments(
        ...
        # overwrite_output_dir removed - not supported in transformers 5.x
        ...
        fp16=True,   # CHANGED: RTX 4050 on Windows is more stable with fp16
        bf16=False,  # CHANGED: bf16 can cause issues on Windows; use fp16 instead
